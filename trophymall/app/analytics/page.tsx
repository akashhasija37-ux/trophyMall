...
const sales = [
  { rank: 1, name: "Rajesh Kumar", orders: 247, revenue: "₹12.45L", target: "₹12L", percent: 103 },
  { rank: 2, name: "Priya Sharma", orders: 232, revenue: "₹11.8L", target: "₹11.5L", percent: 102 },
  { rank: 3, name: "Amit Patel", orders: 218, revenue: "₹10.9L", target: "₹11L", percent: 99 },
  { rank: 4, name: "Neha Singh", orders: 205, revenue: "₹10.45L", target: "₹10.5L", percent: 99 },
  { rank: 5, name: "Vikram Joshi", orders: 198, revenue: "₹9.87L", target: "₹10L", percent: 98 }
]
...
<Card icon={<DollarSign/>} title="Total Revenue (MTD)" value="₹51.8L" sub="+15.2% vs last month"/>

<Card icon={<Box/>} title="Orders Completed" value="2,847" sub="92% on-time delivery"/>

<Card icon={<Users/>} title="Customer Retention" value="85%" sub="+8% improvement"/>

<Card icon={<Award/>} title="Avg. Completion Time" value="10 days" sub="-2 days vs target"/>
...
<div>
<p className="text-white">{i+1}. {p.name}</p>
<p className="text-gray-400 text-sm">{p.units} units sold</p>
</div>
