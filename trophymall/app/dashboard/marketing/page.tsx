    ...
    <div className="flex min-h-screen bg-black">
      ...
      <div className="flex flex-col flex-1">
        ...
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6">
              {segments.map((s, i) => (
                <div key={i} className="bg-zinc-800 rounded-lg p-5">
                  ...
                  <p className="text-gray-400 text-sm">contacts in segment</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
            <h3 className="text-white font-semibold mb-4">All Campaigns</h3>
                  ...
                  <tr key={i} className="border-t border-zinc-800">
                    ...
                    <td className="w-40">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-white text-sm">{c.open}%</span>
                      </div>
                    </td>
                    ...
                    <td>
                      <span
                        className={`px-3 py-1 rounded text-xs ${badge[c.status]}`}
                      >
                        {c.status}
                      </span>
                    </td>
...
function Automation({ name, status }: any) {
  const color = status === "Active" ? "text-green-400" : "text-gray-400";
