...
export default function QuotationPage({ refresh }: any) {
  /* ==============================
     MASTER DATA
  ================================= */
 ...
 const currentInvoice =
  ...
  const saveAllInvoices = async () => {
    try {
      ...
      message.success(`${invoiceTabs.length} quotations saved`);
      refresh?.();
    } catch (err) {
      ...
      <div className="flex flex-col flex-1 h-screen overflow-hidden">
          ...
          <div className="px-6 py-4 space-y-4">
            ...
            <div>
              <p className="text-gray-500 text-xs mb-1">
                Billing Management / <span className="text-gray-300">Quotation</span>
              </p>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-4">
                <h2 className="text-lg font-semibold text-white">
                  Quotation <span className="text-gray-500 text-sm font-normal">{currentInvoice.invoiceNo}</span>
                </h2>
              ...
              <div className="flex items-center gap-2" >
                ...
                <button onClick={saveCurrentQuotation} className="flex items-center gap-2 px-4 py-1.5 text-sm bg-green-700 hover:bg-green-600 rounded text-white font-medium">
            ...
            {showEwayBill && (
              <div className="bg-[#121212] border border-zinc-800 rounded-lg p-5 relative animate-in fade-in slide-in-from-top-4">
                ...
                <div className="grid grid-cols-4 gap-6 mb-5">
                  <div>
                    <label className="text-xs text-gray-400 block mb-2">Quotation No</label>
                    <input 
                      type="text" 
                      readOnly 
                  ...
                  <div>
                    <label className="text-xs text-gray-400 block mb-2">Quotation Value</label>
                    <input 
                      type="text" 
                      readOnly 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-[#121212] border border-zinc-800 rounded-lg p-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        <label className="text-xs text-gray-400 block mb-1">Quotation No</label>
                      ...
                      <div>
                        <label className="text-xs text-gray-400 block mb-1">Quotation Date</label>
              ...
              {/* RIGHT COLUMN (Quotation Calculation) */}
              <div className="bg-[#121212] border border-zinc-800 rounded-lg p-5 flex flex-col">
                <h3 className="text-white font-semibold text-sm mb-4">Quotation Calculation</h3>
                ...
                <div className="space-y-3 text-sm flex-1">
                  ...
                  <div className="flex justify-between items-center text-red-400">
                    <span>Less: Quotation Discount</span>
                    <div className="flex items-center gap-2">
                      <span>-₹</span>
                ...
                <div className="mt-6 border-t border-zinc-800 pt-4">
                  <div className="flex justify-between items-end mb-1">
                    <span className="text-white font-semibold">Final Quotation Amount</span>
                  ...
                  <button onClick={saveCurrentQuotation} className="w-full bg-green-700 hover:bg-green-600 text-white py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-colors">
        ...
        <div className="bg-black border-t border-zinc-800 px-4 py-1.5 text-[11px] flex justify-between items-center text-gray-500 shrink-0">
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-gray-500"></span> Open Quotations: {invoiceTabs.length}</span>
            <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-yellow-500"></span> Draft Quotations: 1</span>
          ...
          <div className="flex gap-3">
            <span className="cursor-pointer hover:text-white" onClick={saveCurrentQuotation}><kbd className="bg-zinc-800 px-1 rounded border border-zinc-700 text-gray-400">F5</kbd> Save</span>
