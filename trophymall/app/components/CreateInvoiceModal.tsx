      ...
      >
        ...
        <div className="mt-6">
          ...
          <div className="space-y-3">
            {items.map((item, index) => (
              <div key={index} className="grid grid-cols-5 gap-4 bg-zinc-800 p-3 rounded items-center">
                <Select
                ...
                <InputNumber min={1} value={item.qty} onChange={(v) => updateItem(index, "qty", v)} style={{ width: "100%" }} />

                <InputNumber value={item.price} disabled style={{ width: "100%" }} />
        ...
        <div className="grid grid-cols-2 gap-8 mt-6">
          <div>
            ...
            <Form.Item label="Salesperson" name="salesperson_id" rules={[{ required: true }]}>
              <Select options={employees.map((e: any) => ({ label: e.name, value: e.id }))} />
            </Form.Item>

            <Form.Item label="Assign Job" name="assigned_to" rules={[{ required: true }]}>
              <Select options={employees.map((e: any) => ({ label: e.name, value: e.id }))} />
            </Form.Item>
          ...
          <div className="bg-zinc-800 p-6 rounded-lg">
            ...
            <div className="flex justify-between mb-2">
              ...
              <InputNumber value={deposit} onChange={(v) => setDeposit(v || 0)} />
            </div>
