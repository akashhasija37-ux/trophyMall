      ...
      <div className="pt-20">
        ...
        <section className="px-10 py-36 text-center bg-gradient-to-b from-black to-zinc-900">
          <h1 className="text-6xl font-bold mb-6 leading-tight">
            Own a <span className="text-amber-400">TrophyMall</span>
            <br />
            Franchise
          </h1>

          <p className="text-gray-400 max-w-2xl mx-auto mb-10 text-lg">
            Join India's premium trophy and awards brand. Build a profitable
            business with manufacturing, marketing and design support from
            TrophyMall.
          </p>
        ...
        <section className="px-10 py-28">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <motion.div
              whileHover={{ y: -10 }}
              className="bg-zinc-900 p-10 rounded-xl"
            >
              <h3 className="text-xl font-semibold mb-4">High Demand Market</h3>
              <p className="text-gray-400">
                Corporate awards, sports events, schools and colleges require
                trophies throughout the year creating strong demand.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                Crystal, acrylic, wooden, fiber trophies and customized
                corporate awards.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">
                TrophyMall manages production and design while franchise
                partners focus on growing local markets.
              </p>
            </motion.div>
          </div>
        </section>
